...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins':[
            #模版中就可以直接使用 static 标签，而不用手动load 
...
# Qiniu配置
QINIU_ACCESS_KEY = '5RSaUf_Pxvtgn7xGURXlIFo9Q6X0HpPoMg5c-p9X'
QINIU_SECRET_KEY = '1-4M7s66tqTGCJAt0xB9TZI7i4X1mH9hDqkbfHqZ'
QINIU_BUCKET_NAME = 'sneaker'
QINIU_DOMAIN = 'http://puh4vu3q7.bkt.clouddn.com/'
